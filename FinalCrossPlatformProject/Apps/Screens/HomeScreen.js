...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    const unsubscribeLatestItems = onSnapshot(collection(db, 'UserPost'), orderBy("createdDate", "desc"), (snapshot) => {
      const latestItems = snapshot.docs.map(doc => ({ id: doc.id, ...doc.data() }));
